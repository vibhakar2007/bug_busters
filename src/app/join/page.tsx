...
export default function JoinPage() {
  ...
  const [quizCode, setQuizCode] = useState('TECH26');
  ...
  useEffect(() => {
    ...
    // Auto-fill active quiz code or phone if user visited previously, default to TECH26
  ...
  return (
    <div className="min-h-screen bg-[#070916] text-white flex flex-col justify-between selection:bg-[#9db40c] selection:text-[#070916] px-4 py-6 sm:py-10">
      {/* Top Header */}
      <div className="max-w-md mx-auto w-full flex items-center justify-between">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-400 hover:text-[#9db40c] transition-colors"
        >
          <ArrowLeft className="w-3.5 h-3.5" />
          <span>Home</span>
        </Link>
        <span className="text-xs font-mono-tabular text-slate-500">Technica Symposium</span>
      </div>
      ...
      <div ref={formRef} className="max-w-md mx-auto w-full my-auto py-6">
        ...
        <Card className="p-6 sm:p-8 bg-[#0d1224] border border-[#283f5f]/60 shadow-2xl">
          <form onSubmit={handleJoin} className="space-y-4">
            ...
            {successMsg && (
              <div className="p-3.5 rounded-xl bg-[#031c6c]/40 border border-[#9db40c]/60 text-slate-200 text-xs flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-[#9db40c] shrink-0 mt-0.5" />
            ...
            <div>
              ...
              <input
                ...
                maxLength={10}
                required
                className="w-full px-4 py-3 bg-[#070916] border border-[#283f5f] rounded-xl text-sm font-mono-tabular font-bold tracking-wider text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#9db40c] focus:border-[#9db40c] transition-all uppercase"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-[#070916] border border-[#283f5f] rounded-xl text-sm text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#9db40c] focus:border-[#9db40c] transition-all"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-[#070916] border border-[#283f5f] rounded-xl text-sm font-mono-tabular text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#9db40c] focus:border-[#9db40c] transition-all"
              />
      ...
      {/* Footer */}
      <footer className="max-w-md mx-auto w-full text-center text-xs text-slate-500 py-4">
